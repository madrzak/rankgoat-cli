...
//   plan add <siteId> --auto [--month] | --title <t> [--keyword --meta --type --intent --angle --date --hub]
//   plan edit <itemId> [--title --keyword --meta --type --intent --angle --date --hub]
...
function briefFromFlags(flags) {
  ...
  // --hub <id> attaches the brief to a content hub; --hub "" detaches it.
  if (flags.hub != null) body.hubId = flags.hub === "" ? null : Number(flags.hub);
  return body;
}
