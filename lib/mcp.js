...
export const TOOLS = [
  ...
  {
    name: "list_posts",
    description: "List a site's generated posts with status (draft, ready_to_publish, published, verified).",
    props: { siteId: num("Site ID"), status: str("Filter by status") },
    required: ["siteId"],
    run: (c, a) => c.get(`/sites/${a.siteId}/posts`, { query: { status: a.status } }),
  },
  {
    name: "get_post",
  ...
  {
    name: "get_backlinks",
    description: "The site's inbound and outbound link graph: live dofollow backlinks, sources, anchors, status.",
    props: { siteId: num("Site ID") },
    required: ["siteId"],
