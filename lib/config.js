...
// RANKGOAT_CONFIG_DIR relocates the config dir (tests, CI sandboxes); it's read
// lazily so it can be set after import.
...
function configDir() {
  return process.env.RANKGOAT_CONFIG_DIR || join(homedir(), ".rankgoat");
}
